...
const INVALID_PARAMS_SPECIAL_STRINGS = INVALID_PARAMS.slice(0);
INVALID_PARAMS_SPECIAL_STRINGS.push('invalid_special_string_value');

export {
  INVALID_PARAMS,
  INVALID_PARAMS_EMPTY_STRING_ALLOWED,
  INVALID_PARAMS_NOT_DEFINED_ALLOWED,
  INVALID_PARAMS_SPECIAL_STRINGS
};
