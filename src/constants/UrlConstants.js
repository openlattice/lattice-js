...
export const METADATA_PATH :string = 'metadata';
...
export const PROPERTIES_PATH :string = 'properties';
export const PROPERTY_TYPE_PATH :string = 'property/type';
export const REFRESH_PATH :string = 'refresh';
...
export const VERSION_PATH :string = 'version';
