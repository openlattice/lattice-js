...
})(this, function(__WEBPACK_EXTERNAL_MODULE_184__, __WEBPACK_EXTERNAL_MODULE_185__, __WEBPACK_EXTERNAL_MODULE_186__, __WEBPACK_EXTERNAL_MODULE_294__, __WEBPACK_EXTERNAL_MODULE_295__, __WEBPACK_EXTERNAL_MODULE_296__, __WEBPACK_EXTERNAL_MODULE_297__, __WEBPACK_EXTERNAL_MODULE_298__, __WEBPACK_EXTERNAL_MODULE_299__, __WEBPACK_EXTERNAL_MODULE_300__, __WEBPACK_EXTERNAL_MODULE_301__) {
...
var _loglevel = __webpack_require__(290);
...
var _isError = __webpack_require__(283);
...
var _isNull = __webpack_require__(285);
...
var _trim = __webpack_require__(289);
...
var _uuidValidate = __webpack_require__(293);

var _uuidValidate2 = _interopRequireDefault(_uuidValidate);

var _PermissionTypes = __webpack_require__(28);
...
var _EntitySet = __webpack_require__(19);
...
var _PropertyType = __webpack_require__(20);
...
var _RequestStatus = __webpack_require__(33);
...
var _PrincipalTypes = __webpack_require__(29);
...
var _SecurableTypes = __webpack_require__(31);
...
var EntityTypeBuilder = exports.EntityTypeBuilder = function () {
  ...
  _createClass(EntityTypeBuilder, [{
    ...
    value: function setBaseType(baseType) {
      ...
      if (!(0, _ValidationUtils.isValidUuid)(baseType)) {
    ...
    value: function setCategory(category) {
      ...
      if (!(0, _LangUtils.isNonEmptyString)(category) || !_SecurableTypes2.default[category]) {
    ...
    value: function build() {
      ...
      return new EntityType(this.id, this.type, this.title, this.description, this.schemas, this.key, this.properties, this.baseType, this.category);
    }
  }]);
...
function isValid(entityType) {
  ...
  try {
    ...
    // optional properties
    if ((0, _has2.default)(entityType, 'id')) {
      entityTypeBuilder.setId(entityType.id);
    }

    if ((0, _has2.default)(entityType, 'description')) {
      entityTypeBuilder.setDescription(entityType.description);
    }

    if ((0, _has2.default)(entityType, 'baseType')) {
      entityTypeBuilder.setBaseType(entityType.baseType);
    }

    if ((0, _has2.default)(entityType, 'category')) {
...
function isValid(entitySet) {
  ...
  try {
    ...
    // optional properties
    if ((0, _has2.default)(entitySet, 'id')) {
      entitySetBuilder.setId(entitySet.id);
    }

    if ((0, _has2.default)(entitySet, 'description')) {
...
function isValid(propertyType) {
  ...
  try {
    ...
    // optional properties
    if ((0, _has2.default)(propertyType, 'id')) {
      propertyTypeBuilder.setId(propertyType.id);
    }

    if ((0, _has2.default)(propertyType, 'description')) {
...
function isValid(request) {
  ...
  try {
    ...
    // optional properties
    if ((0, _has2.default)(request, 'reason')) {
...
var _RequestStateTypes = __webpack_require__(30);
...
var _EnvToUrlMap = __webpack_require__(216);
...
function isValid(linkingEntityType) {
  ...
  try {
    ...
    // optional properties
    if ((0, _has2.default)(linkingEntityType, 'deidentified')) {
...
function isValid(organization) {
  ...
  try {
    ...
    // optional properties
    if ((0, _has2.default)(organization, 'id')) {
      organizationBuilder.setId(organization.id);
    }

    if ((0, _has2.default)(organization, 'description')) {
...
var https = __webpack_require__(185);
var Writable = __webpack_require__(298).Writable;
var debug = __webpack_require__(219)('follow-redirects');
...
var _isFinite = __webpack_require__(284);
...
function advancedSearchEntitySetData(entitySetId, searchOptions) {
  ...
  if (!(0, _LangUtils.isNonEmptyObject)(searchFields)) {
    errorMsg = 'invalid parameter: searchFields must be a non-empty object';
    LOG.error(errorMsg, searchFields);
    return Promise.reject(errorMsg);
  }

  var searchFieldsMap = _immutable2.default.fromJS(searchFields);

  var allKeysUuids = searchFieldsMap.keySeq().every(function (key) {
    return (0, _ValidationUtils.isValidUuid)(key);
  });

  var allValuesUuids = searchFieldsMap.valueSeq().every(function (value) {
    return (0, _LangUtils.isNonEmptyString)(value);
  });
...
var url = __webpack_require__(186);
var zlib = __webpack_require__(301);
var pkg = __webpack_require__(221);
var Buffer = __webpack_require__(295).Buffer;
var createError = __webpack_require__(26);
var enhanceError = __webpack_require__(42);
...
var tty = __webpack_require__(299);
...
function createWritableStdioStream (fd) {
  ...
  switch (tty_wrap.guessHandleType(fd)) {
    ...
    case 'PIPE':
    case 'TCP':
      var net = __webpack_require__(297);
...
var asciiToArray = __webpack_require__(230),
    hasUnicode = __webpack_require__(250),
...
var baseToString = __webpack_require__(59),
    ...
    stringToArray = __webpack_require__(275),
    toString = __webpack_require__(68);
